                        ...
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <p>Far far away, behind the word mountains, far from the
                                    ...
                                    regelialia.</p>
                                <p><a href="#" class="btn btn-primary">Get in touch with
                                        us</a></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <div class="img" style="background-image: url(images/bg_4.jpg);">
                    ...
                    <p>We can manage your dream building A small river named Duden flows
                        by their place</p>
                    <p class="mb-0"><a href="#" class="btn btn-primary px-4 py-3">Enroll
                            Now</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    ...
                    rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a
