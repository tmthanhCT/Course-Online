    ...
    <div
      ...
      <div class="col-md-9 ftco-animate pb-5 text-center">
        <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i
            ...
            class="mr-2"><a href="index.html">Blog <i
    ...
    <div class="row">
      <div class="col-lg-8 ftco-animate py-md-5 mt-md-5">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis,
          ...
          optio deserunt molestiae voluptates soluta architecto tempora.</p>
        <p>
          <img src="images/image_1.jpg" alt class="img-fluid">
        </p>
        <p>Molestiae cupiditate inventore animi, maxime sapiente optio, illo est
        ...
        <p>Temporibus ad error suscipit exercitationem hic molestiae totam
          ...
          hic non? Debitis commodi aut, adipisci.</p>
        <p>
          <img src="images/bg_1.jpg" alt class="img-fluid">
        </p>
        <p>Quisquam esse aliquam fuga distinctio, quidem delectus veritatis
        ...
        <div class="pt-5 mt-5">
          <h3 class="mb-5" style="font-size: 20px; font-weight: bold;">6
            Comments</h3>
          ...
          <div class="comment-form-wrap pt-5">
            <h3 class="mb-5" style="font-size: 20px; font-weight: bold;">Leave a
              comment</h3>
          ...
          <div class="block-21 mb-4 d-flex">
            ...
            <div class="text">
              <h3 class="heading"><a href="#">Even the all-powerful Pointing has
                  no control about the blind texts</a></h3>
              <div class="meta">
                <div><a href="#"><span class="fa fa-calendar"></span> Sept. 17,
                    2020</a></div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          ...
          rights reserved | This template is made with <i class="fa fa-heart"
